...
func (s *Server) routes() {
	...
	s.mux.HandleFunc(s.route("GET /api/union/admin/blacklist"), s.withAdminAuth(s.handleBlacklistList))
	s.mux.HandleFunc(s.route("POST /api/union/admin/blacklist"), s.withAdminAuth(s.handleBlacklistCreate))
	s.mux.HandleFunc(s.route("PUT /api/union/admin/blacklist/invalidate/{id}"), s.withAdminAuth(s.handleBlacklistInvalidate))
	s.mux.HandleFunc(s.route("DELETE /api/union/admin/blacklist/{id}"), s.withAdminAuth(s.handleBlacklistDelete))

	s.mux.HandleFunc(s.route("POST /api/union/admin/sync"), s.withAdminAuth(s.handleAdminSync))
	s.mux.HandleFunc(s.route("POST /api/union/admin/update-list"), s.withAdminAuth(s.handleAdminUpdateList))
	s.mux.HandleFunc(s.route("POST /api/union/admin/update-key"), s.withAdminAuth(s.handleAdminUpdateKey))
	s.mux.HandleFunc(s.route("POST /api/union/admin/diagnose"), s.withAdminAuth(s.handleAdminDiagnose))
	s.mux.HandleFunc(s.route("GET /api/union/admin/status"), s.withAdminAuth(s.handleAdminStatus))
	s.mux.HandleFunc(s.route("GET /api/union/admin/keypair-fingerprint"), s.withAdminAuth(s.handleAdminKeypairFingerprint))
	s.mux.HandleFunc(s.route("POST /api/union/admin/regenerate-keypair"), s.withAdminAuth(s.handleAdminRegenerateKeypair))
